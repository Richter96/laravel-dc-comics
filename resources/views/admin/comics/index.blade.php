                            ...
                            <td class="">
                                <div class="row row-cols-3">
                                    ...
                                    <div class="icon d-inline">
                                        <a name="" id="" class="btn btn-primary w-1rem"
                                            href="{{ Route('comics.show', $comic->id) }}" role="button"><i
                                                class="fas fa-eye fa-sm fa-fw"></i></a>
                                    </div>

                                    <div class="icon d-inline">
                                        <a name="" id="" class="btn btn-primary w-1rem"
                                            href="{{ Route('comics.edit', $comic->id) }}" role="button"><i
                                                class="fas fa-pencil fa-sm fa-fw"></i></a>
                                    </div>

                                    <div class="icon d-inline">
                                        <!-- Modal trigger button -->
                                        <button type="button" class="btn btn-danger btn-lg ratio-1x1 w-1rem p-0"
                                            data-bs-toggle="modal" data-bs-target="#modal-{{ $comic->id }}">
